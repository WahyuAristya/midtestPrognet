...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    <!-- Brand Logo -->
    <li class="brand-link">
      <span class="brand-text font-weight-warning text-danger"><h4><strong>Layanan Keluhan</strong></h4></span>
    </li>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <li class="d-block text-dark">{{Auth::User()->name}}</li>
        </div>
      </div>

      <!-- Sidebar Menu -->
      @include('layouts.admin.menudashboard')
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
